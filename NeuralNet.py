...
class Perceptron(object):
    ...
    def __init__(self, inSize=1, weights=None):
        ...
        if weights is None:
            #weights of previous layers into this one, random if passed in as None͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
...
class NeuralNet(object):
    ...
    def __init__(self, layerSize):#default 3 layer, 1 percep per layer
        ...
        #build hidden layer(s)͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
        ...
        #build output layer͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
        for i in range(layerSize[-1]):
            percep = Perceptron(layerSize[-2]) # num of perceps feeding into this one
            self.outputLayer.append(percep)

        #build layers list that holds all layers in order - use this structure͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
        # to implement back propagation͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
    ...
    def backPropLearning(self, examples, alpha):
        ...
        """
        #keep track of output͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
        averageError = 0
        averageWeightChange = 0
        numWeights = 0

        for example in examples:#for each example
            #keep track of deltas to use in weight change͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
            deltas = []
            #Neural net output list͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
            allLayerOutput = """FILL IN - neural net output list computation"""
            lastLayerOutput = allLayerOutput[-1]
            #Empty output layer delta list͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
            outDelta = []
            #iterate through all output layer neurons͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
            ...
            for layerNum in range(self.numHiddenLayers-1,-1,-1):
                ...
                hiddenDelta = []
                #Iterate through all neurons in this layer͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
            ...
            #end for each example͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
        #calculate final output͏󠄂͏️͏󠄌͏󠄎͏󠄄͏󠄏͏󠄆
